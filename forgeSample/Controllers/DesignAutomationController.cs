...
namespace forgeSample.Controllers
{
    ...
    public class DesignAutomationController : ControllerBase
    {
        ...
        private dynamic EngineAttributes(string engine)
        {
            ...
            //if (engine.Contains("Revit")) return new { commandLine = "$(engine.path)\\revitcoreconsole.exe /i \"$(appbundles[{0}].path)\"", extension = "rvt", script = string.Empty };
            ...
            if (!activities.Data.Contains(qualifiedActivityId))
            {
                ...
                Activity activitySpec = new Activity()
                {
                    ...
                    Parameters = new Dictionary<string, Parameter>()
                    {
                        ...
                        { "inputFile", new Parameter() { Description = "input file", LocalName = "myzip", Ondemand = false, Required = true, Verb = Verb.Get, Zip = true } },
                        //{ "inputFile", new Parameter() { Description = "input file", LocalName = "input.rvt", Ondemand = false, Required = true, Verb = Verb.Get, Zip = false } },
        ...
        public async Task<IActionResult> StartWorkitem([FromForm]StartWorkitemInput input)
        {
            ...
            XrefTreeArgument inputFileArgument = new XrefTreeArgument()
            {
                ...
                //Url = "https://developer.api.autodesk.com/oss/v2/buckets/wip.dm.prod/objects/14d364ef-389f-402b-8c89-48b459ec27b2.rvt",
                Url = "https://developer.api.autodesk.com/oss/v2/buckets/wip.dm.prod/objects/20c7d697-067c-49d8-9e37-9aa731119431.rvt",
                LocalName = "myzip",
                PathInZip = "0933-XX-XX20_000-MDN-EST-EST-M3-EN1-ZZZ-001-General.rvt",
        ...
        public async Task<IActionResult> OnCallback(string id, string outputFileName, [FromBody]dynamic body)
        {
            try
            {
                ...
                await _hubContext.Clients.Client(id).SendAsync("downloadResult", url);
            }
            catch { }
